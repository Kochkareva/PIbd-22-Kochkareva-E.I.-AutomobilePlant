...
namespace AutomobilePlantListImplement.Implements
{
    public class ImplementerStorage : IImplementerStorage
    {
        ...
        public List<ImplementerViewModel> GetFilteredList(ImplementerBindingModel model)
        {
            ...
            foreach (var implementer in source.Implementers)
            {
                if (implementer.ImplementerFullName.Contains(model.ImplementerFullName))
                {
                    result.Add(CreateModel(implementer));
                }
            }
        ...
        public ImplementerViewModel GetElement(ImplementerBindingModel model)
        {
            ...
            foreach (var implementer in source.Implementers)
            {
                if (implementer.Id == model.Id || implementer.ImplementerFullName == model.ImplementerFullName)
                {
